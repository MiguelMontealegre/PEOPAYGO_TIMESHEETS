...
export class ListPageComponent extends CollectionComponent<PaymentType> {
  breadCrumbs = [
    { label: 'Payment types', active: true },
  ];
  TRANSLATE_KEY= 'ADMIN.USERS.PAGES.LIST.'



  private subject$: BehaviorSubject<PaymentType | null> =
    new BehaviorSubject<PaymentType | null>(null);

  constructor(
    router: Router,
    location: Location,
    api: CommonApiService,
    service: CollectionService<PaymentType>,
